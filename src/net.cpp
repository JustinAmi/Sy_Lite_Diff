...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Sycoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"sycoin.io", "dnsseed.sycoin.io"},
   
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"sycointools.com", "testnet-seed.sycointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Sycoin is probably already running."), addrBind.ToString().c_str());
        else
